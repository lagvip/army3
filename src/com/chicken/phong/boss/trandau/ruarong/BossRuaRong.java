...
/**
 * Trận riêng của map 58 - Boss Rùa x Rồng.
 * Hai Rùa máy chạy theo địa hình, Rồng máy bay bắn từ xa và hai Phiến quân hỗ trợ bắn súng.
 */
public final class BossRuaRong extends ChickenQuanLyChien {
    ...
    private final CauHinhBossRuaRong.CauHinh[] cauHinhBoss =
            new CauHinhBossRuaRong.CauHinh[SO_SLOT];
    ...
    /** Hai Rùa map 58 có bộ đếm lượt riêng, không dùng chung với nhau. */
    ...
    public BossRuaRong(SanhChoBoss sanh) {
        super(null, layNguoiChoiTheoGhe(sanh),
                (byte) CauHinhBossRuaRong.MAP_ID, false);
        this.sanh = sanh;
        this.banDo = new ChickenQuanLyBanDo(CauHinhBossRuaRong.MAP_ID);
        this.boHenGio = Executors.newSingleThreadScheduledExecutor(r -> {
            Thread thread = new Thread(r, "boss-rua-rong-P4-"
    ...
    public static BossRuaRong tao(SanhChoBoss sanh) {
        if (sanh == null || (sanh.getMaBanDo() & 0xFF) != CauHinhBossRuaRong.MAP_ID) {
            return null;
        }
        return new BossRuaRong(sanh);
    }
    ...
    public synchronized void batDau() throws IOException {
        ...
        this.daBatDau = true;
        for (CauHinhBossRuaRong.CauHinh cauHinh : CauHinhBossRuaRong.layTatCa()) {
            System.out.println("[BOSS RUA RONG][TAO_BOSS] slot="
            ...
            for (CauHinhBossRuaRong.CauHinh cauHinh : CauHinhBossRuaRong.layTatCa()) {
                if (cauHinh.laRua()) {
                    nguoiNhan.nguoiChoi.dichVu.guiTaoBossRua(
                            ...
                            cauHinh.getHead(), cauHinh.getLeg(), cauHinh.getBody(),
                            cauHinh.getHat(), cauHinh.getWing(), cauHinh.getVuKhi(),
                            cauHinh.getX(), cauHinh.getY(), cauHinh.getMau());
                } else if (cauHinh.laRong()) {
        ...
        System.out.println("[BOSS RUA RONG][BAT_DAU] P4-"
    ...
    public synchronized void ban(ChickenNguoiChoi nguoiChoi, ChickenTinNhan ms)
        ...
        if (!this.daKetThuc) {
            int napDanSauBan = napDanVatPham > 0 ? napDanVatPham
    ...
    public synchronized void kiemTraVaCham(ChickenNguoiChoi nguoiChoi, ChickenTinNhan ms)
        ...
        System.out.println("[BOSS RUA RONG][CMD79_HIEN_THI_XONG] slotBan="
    ...
    public synchronized void khiNguoiChoiRoi(ChickenNguoiChoi nguoiChoi) {
        ...
        System.out.println("[BOSS RUA RONG][NGUOI_CHOI_ROI] player="
    ...
    private void taoBoss() {
        for (CauHinhBossRuaRong.CauHinh cauHinh : CauHinhBossRuaRong.layTatCa()) {
            ...
            int tanCong = cauHinh.laRong() ? CauHinhBossRuaRong.SAT_THUONG_RONG : (cauHinh.laRua() ? CauHinhBossRuaRong.SAT_THUONG_RUA : CauHinhBossRuaRong.layTanCongTheoSung(cauHinh.getVuKhi()));
        ...
        this.kyNangHawkBoss = new ChickenKyNangDacBietHawk(
                ...
                new ChickenKyNangDacBietHawk.DieuKhienTranDau() {
                    ...
                    public boolean daKetThuc() {
                        return BossRuaRong.this.daKetThuc;
                    }

                    @Override
                    public byte luotHienTai() {
                        return BossRuaRong.this.luotHienTai;
                    }
                    ...
                    public void guiHoatAnhMuiTen(
                        ...
                        BossRuaRong.this.phatHoatAnhMuiTenHawkBoss(
                                hawk, goc, duongDan);
                    }
                    ...
                    public void gaySatThuong(
                        ...
                        BossRuaRong.this.gaySatThuong(mucTieu, satThuong);
                    }

                    @Override
                    public void sangLuot() throws IOException {
                        BossRuaRong.this.sangLuotSauKyNangAVG();
                    }
                }
        );
        ...
        this.kyNangThorBoss = new ChickenKyNangDacBietThor(
                ...
                new ChickenKyNangDacBietThor.DieuKhienTranDau() {
                    ...
                    public void guiTiaSet(
                        ...
                        BossRuaRong.this.phatTiaSetThorBoss(
        ...
        this.kyNangLokiBoss = new ChickenKyNangDacBietLoki(
                ...
                new ChickenKyNangDacBietLoki.DieuKhienTranDau() {
                    ...
                    public void guiBienHinh(
                        ...
                        BossRuaRong.this.phatBienHinhLokiBoss(loki, mucTieu);
                    }

                    @Override
                    public void capNhatMau(ChickenChienBinh loki)
                            throws IOException {
                        BossRuaRong.this.phatCapNhatMau(loki);
                    }
                }
        );
    ...
    private void xuLyHetThoiGianLuot(int slot, long phien) {
        synchronized (this) {
            ...
            System.out.println("[BOSS RUA RONG][HET_25_GIAY] slot=" + slot
    ...
    private int layNapDanKhiHetThoiGian(int slot, ChickenChienBinh chienBinh) {
        ...
        CauHinhBossRuaRong.CauHinh cauHinh = slot >= 0 && slot < this.cauHinhBoss.length
        ...
        return chienBinh == null
                ? 100
                : CauHinhBossRuaRong.layNapDanTheoSung(chienBinh.maVuKhi);
    }
    ...
    private void thucHienLuotBoss(int slot, long phien) {
        synchronized (this) {
            ...
            CauHinhBossRuaRong.CauHinh cauHinh = this.cauHinhBoss[slot];
            ...
            } else if (cauHinh.laRua()) {
                int soLuot = this.tangVaLaySoLuotRua(slot);
                ChieuBossRua.LoaiChieu chieu =
                        ChieuBossRua.chonChoLuot(soLuot);
                ChickenChienBinh mucTieuRua =
                        DiChuyenBossRua.timNguoiSongGanNhat(
                                boss, this.chienBinhs);
                System.out.println("[BOSS RUA RONG][CHON_CHIEU_RUA] slot="
                        + slot + " luotRua=" + soLuot + " chieu=" + chieu);
                this.thucHienBossRua(
                        boss, slot, phien,
                        DiChuyenBossRua.QUANG_DUONG_MOI_LUOT,
                        DiChuyenBossRua.layHuongX(boss, mucTieuRua),
                        chieu, false);
            } else if (cauHinh.laRong()) {
                this.thucHienBossRong(boss, slot, phien);
            } else {
                this.sangLuotSauBoss(slot, phien, 0);
            }
        }
    ...
    private void thucHienBossRua(
        ...
        synchronized (this) {
            if (this.daKetThuc || this.maPhienLuot != phien || boss == null || boss.chet) {
                this.sangLuotSauBoss(slot, phien, 0);
                return;
            }
            ChickenChienBinh mucTieu = DiChuyenBossRua.timNguoiSongGanNhat(boss, this.chienBinhs);
            if (mucTieu == null) {
                this.sangLuotSauBoss(slot, phien, CauHinhBossRuaRong.NAP_DAN_SAU_HANH_DONG);
                return;
            }
            ...
            while (conLai > 0 && baoHiem++ < 256) {
                ...
                boss.x = kepShort(
                        ...
                        this.banDo.getWidth() - 1
                                - DiChuyenBossRua.NUA_RONG_HITBOX);
                boss.y = kepShort(
                        buoc[1], 0, this.banDo.getHeight() + 40);
                coDiChuyen = true;
    ...
    private void tungChieuRuaSauDiChuyen(
        ...
        System.out.println("[BOSS RUA RONG][CHO_DI_CHUYEN_XONG] slot=" + slot
                + " from=" + xCu + "," + yCu
                + " to=" + boss.x + "," + boss.y
                + " delayMs=" + treMs);
        short xDich = boss.x;
    ...
    private void hoanTatDiChuyenVaTungChieuRua(
        ...
        synchronized (this) {
            ...
            try {
                ...
                System.err.println("[BOSS RUA RONG][LOI_CHOT_DI_CHUYEN] slot="
        ...
        synchronized (this) {
            ...
            if (mucTieu == null) {
                this.sangLuotSauBoss(
                        slot, phien,
                        CauHinhBossRuaRong.NAP_DAN_SAU_HANH_DONG);
                return;
            }
            ...
            if (!this.banDo.themDaRua(xVaCham, yVaCham)) {
                System.err.println("[BOSS RUA RONG][DAM_DA_BO_QUA] "
            ...
            System.out.println("[BOSS RUA RONG][DAM_DA] boss=" + boss.ten
                    + " target=" + mucTieu.ten
                    + " damage=" + satThuong
    ...
    private void banDanRua(ChickenChienBinh boss, ChickenChienBinh mucTieu, int slot, long phien) {
        synchronized (this) {
            if (this.daKetThuc || this.maPhienLuot != phien || boss == null || boss.chet) {
                this.sangLuotSauBoss(slot, phien, 0);
                return;
            ...
            ChickenKetQuaDan ketQua = BossRuaRongTanCong.taoPhatBanRua(
                    boss, mucTieu, this.chienBinhs, this.banDo,
                    this.layWindXChoChienBinh(boss), this.layWindYChoChienBinh(boss));
            ChickenMayMan.PhienTanCong phienMayMan =
            ...
            try {
                ...
                if (ketQua.mucTieu != null && ketQua.satThuong > 0) {
                    ...
                    if (DocBossRua.apDung(
                        ...
                        System.out.println(
                                "[BOSS RUA RONG][NHIEM_DOC] target="
                                + ketQua.mucTieu.ten
                                + " damageMoiLuot="
    ...
    private boolean xuLyDocDauLuot(ChickenChienBinh mucTieu)
        ...
        System.out.println("[BOSS RUA RONG][DOC_DAU_LUOT] target="
                + mucTieu.ten
    ...
    private void thucHienBossRong(ChickenChienBinh boss, int slot, long phien) {
        synchronized (this) {
            if (this.daKetThuc || this.maPhienLuot != phien || boss == null || boss.chet) {
                this.sangLuotSauBoss(slot, phien, 0);
                return;
            }
            ChickenChienBinh mucTieu = DiChuyenBossRong.timNguoiSongGanNhat(boss, this.chienBinhs);
            if (mucTieu == null) {
                this.sangLuotSauBoss(slot, phien, CauHinhBossRuaRong.NAP_DAN_SAU_HANH_DONG);
                return;
            }
            boolean gapNguoi = BossRong.chonGapNguoiChoLuot();
            System.out.println("[BOSS RUA RONG][CHON_DON_RONG] kieu="
                    + (gapNguoi ? "GAP_THA" : "BAN_TU_XA")
                    + " target=" + mucTieu.ten);
            if (gapNguoi) {
                this.bayDenGapNguoiRong(
                        boss, mucTieu, slot, phien);
            } else {
                this.bayQuanhRoiBanRong(
                        boss, mucTieu, slot, phien);
            }
        }
    }

    private void bayQuanhRoiBanRong(
            ChickenChienBinh boss,
            ChickenChienBinh mucTieu,
            int slot,
            long phien
        ...
        synchronized (this) {
            if (!this.conHieuLucLuotBossRong(slot, phien, boss)
                    || !this.nguoiChoiConSongRong(mucTieu)) {
                this.sangLuotSauBoss(
                        slot,
                        phien,
                        CauHinhBossRuaRong.NAP_DAN_SAU_HANH_DONG);
            ...
            boss.y = diemDen[1];
            try {
                this.phatDiChuyenRong(boss);
            } catch (IOException loi) {
                System.err.println(
                        "[BOSS RUA RONG][LOI_GUI_RONG_BAY_QUANH] "
                        + loi.getMessage());
            }
            long thoiGianBay = DiChuyenBossRong.tinhThoiGianBayMs(
                    xCu, yCu, boss.x, boss.y)
                    + CauHinhBossRong.TRE_DU_PHONG_BAY_QUANH_TRUOC_BAN_MS;
            System.out.println("[BOSS RUA RONG][RONG_BAY_QUANH] target="
                    + mucTieu.ten
                    + " tu=" + xCu + "," + yCu
                    + " den=" + boss.x + "," + boss.y
    ...
    private void rongBanTuXa(
        ...
        synchronized (this) {
            ...
            ChickenChienBinh mucTieuMoi = this.nguoiChoiConSongRong(mucTieu)
                    ? mucTieu
            ...
            ChickenKetQuaDan ketQua = BossRuaRongTanCong.taoPhatBanRong(
                    boss,
                    mucTieuMoi,
                    this.chienBinhs,
                    this.banDo,
            ...
            int tongSatThuong =
                    BossRongTanCong.tinhTongSatThuongLoat(
                            ketQua.satThuong);
            System.out.println("[BOSS RUA RONG][RONG_BAN_LOAT] target="
                    + mucTieuMoi.ten
    ...
    private void phatLoatHaiVienRong(
        ...
        synchronized (this) {
            ...
            ChickenMayMan.PhienTanCong phienMayMan =
                    ChickenMayMan.batDau(boss, this.chienBinhs);
            try {
                // Type 1 native nhả hai path trong cung mot packet. Gui hai
                // CMD22 lien tiep se ghi de BM.active cua client.
                this.phatBan(boss, ketQua, (byte) 1);
                int tongSatThuong =
                        BossRongTanCong.tinhTongSatThuongLoat(
                                ketQua.satThuong);
                if (ketQua.mucTieu != null
                        ...
                        && !ketQua.mucTieu.chet
                        && !this.daKetThuc) {
                    // Client ve hai vien, server chi phat mot cap nhat HP
                    // de hien mot so damage tong.
                    tongSatThuong = phienMayMan.apDung(
                            ketQua.mucTieu, tongSatThuong);
                    this.gaySatThuong(ketQua.mucTieu, tongSatThuong);
                }
            } catch (IOException loi) {
                System.err.println("[BOSS RUA RONG][LOI_RONG_BAN_LOAT] "
                        + loi.getMessage());
            }
            System.out.println("[BOSS RUA RONG][RONG_BAN_LOAT_GUI] packet=1"
    ...
    private void bayDenGapNguoiRong(
            ChickenChienBinh boss,
            ChickenChienBinh mucTieu,
            int slot,
            long phien
        ...
        synchronized (this) {
            ...
            short xTha = diemTha == null ? diemMang[0] : diemTha[0];
            short yTha = (short) (diemTha != null
                    ? diemTha[1]
                    : this.banDo.getHeight() + 24);
            boolean roiXuongVuc = diemTha == null;
            long thoiGianHoatAnh = this.tinhThoiGianGapThaRong(
                    boss,
                    mucTieu,
                    diemMang[0],
                    diemMang[1],
            ...
            System.out.println("[BOSS RUA RONG][RONG_GAP_THA] target="
                    + mucTieu.ten
                    + " xMang=" + diemMang[0]
                    + " yMang=" + diemMang[1]
                    + " xTha=" + xTha
            ...
            this.boHenGio.schedule(() -> this.hoanTatGapThaNguoiRong(
                            boss,
                            mucTieu,
                            slot,
                            phien,
    ...
    private void hoanTatGapThaNguoiRong(
            ChickenChienBinh boss,
            ChickenChienBinh mucTieu,
            int slot,
            long phien,
        ...
        synchronized (this) {
            ...
            mucTieu.x = xTha;
            mucTieu.y = yTha;
            this.phatChotToaDoGapThaRong(boss, mucTieu);
            int satThuong = roiXuongVuc
                    ? Math.max(1, mucTieu.hp)
                    : Math.max(
                            1,
                            CauHinhBossRuaRong.SAT_THUONG_GAP_THA_RONG
                                    - mucTieu.giap);
            ...
            try {
                this.gaySatThuong(mucTieu, satThuong);
                System.out.println(
                        "[BOSS RUA RONG][RONG_GAP_THA_XONG] target="
                        + mucTieu.ten
                        + " damage=" + satThuong
                        + " x=" + mucTieu.x
                        + " y=" + mucTieu.y);
    ...
    /** Chot lai toa do authoritative sau animation -68 cua Rong map 58. */
    private void phatChotToaDoGapThaRong(
            ChickenChienBinh boss,
            ChickenChienBinh mucTieu
    ) {
        for (ChickenChienBinh nguoiNhan : this.nguoiChoiConPhien()) {
            try {
                ...
                System.err.println(
                        "[BOSS RUA RONG][LOI_CHOT_TOA_DO_RONG] player="
            ...
            try {
                ...
                System.err.println(
                        "[BOSS RUA RONG][LOI_CHOT_TOA_DO_NGUOI] player="
                        + nguoiNhan.ten + " loi=" + loi.getMessage());
            }
        }
    }

    private long tinhThoiGianGapThaRong(
            ChickenChienBinh boss,
            ChickenChienBinh mucTieu,
            int xMang,
            int yMang,
        ...
        double khoangTha = Math.hypot(
                xTha - xMang,
                yTha - (yMang + CauHinhBossRong.LECH_Y_NGUOI_BI_KEP));
    ...
    private boolean conHieuLucLuotBossRong(
            int slot,
            long phien,
            ChickenChienBinh boss
    ) {
    ...
    private boolean nguoiChoiConSongRong(ChickenChienBinh nguoiChoi) {
    ...
    private void phatHoatAnhGapThaBossRong(
        ...
        for (ChickenChienBinh nguoiNhan : this.nguoiChoiConPhien()) {
            try {
                ...
                System.err.println(
                        "[BOSS RUA RONG][LOI_GUI_RONG_GAP_THA] player="
                        + nguoiNhan.ten
                        + " loi=" + loi.getMessage());
            }
        }
    ...
    private void thucHienBossBanSung(ChickenChienBinh boss, int slot, long phien) {
        ...
        if (mucTieu == null) {
            this.sangLuotSauBoss(slot, phien,
                    CauHinhBossRuaRong.layNapDanTheoSung(boss.maVuKhi));
            return;
        }
        ...
        System.out.println("[BOSS RUA RONG][BOSS_BAN] boss=" + boss.ten
                + " target=" + mucTieu.ten
    ...
    private boolean daTrongPhamViNo(
        ...
        long banKinh = CauHinhBossRuaRong.BAN_KINH_KICH_NO;
    ...
    private void xuLyCamTuRoiKhoiMap(
        ...
        try {
            ...
            System.out.println("[BOSS RUA RONG][CAM_TU_ROI_MAP] boss="
    ...
    private void noCamTu(
        ...
        try {
            CauHinhBossRuaRong.CauHinh cauHinh =
                    CauHinhBossRuaRong.layTheoSlot(slot);
            int satThuongGoc;
            if (cauHinh != null && cauHinh.laRong()) {
                satThuongGoc = CauHinhBossRuaRong.SAT_THUONG_RONG;
            } else if (cauHinh != null && cauHinh.laRua()) {
                satThuongGoc = CauHinhBossRuaRong.SAT_THUONG_RUA;
            } else if (cauHinh != null) {
                satThuongGoc = CauHinhBossRuaRong.layTanCongTheoSung(
                        cauHinh.getVuKhi());
            } else {
                satThuongGoc = CauHinhBossRuaRong.SAT_THUONG_CAM_TU;
            }
            int satThuongThuc = Math.max(1, satThuongGoc - mucTieu.giap);
            ChickenMayMan.PhienTanCong phienMayMan =
                    ChickenMayMan.batDau(camTu, this.chienBinhs);
            satThuongThuc = phienMayMan.apDung(
                    mucTieu, satThuongThuc);
            ...
            camTu.chet = true;
            this.phatCapNhatMau(camTu);
            System.out.println("[BOSS RUA RONG][CAM_TU_NO] boss=" + camTu.ten
                    + " target=" + mucTieu.ten + " damage="
                    + satThuongThuc
                    + " damageGoc=" + satThuongGoc
                    + " giap=" + mucTieu.giap
                    + " bossTuChet=true");
        } catch (IOException ignored) {
        }
    ...
    private ChickenKetQuaDan banX3UltronBoss(
        ...
        System.out.println("[BOSS RUA RONG][ULTRON_X3] player="
                + shooter.ten + " goc=" + goc
        ...
        this.boHenGio.schedule(() -> {
            synchronized (this) {
                ...
                try {
                    ...
                    System.err.println("[BOSS RUA RONG][LOI_KET_THUC] "
                            + loi.getMessage());
                }
            }
    ...
    private synchronized void ketThuc(boolean nguoiChoiThang) throws IOException {
        ...
        System.out.println("[BOSS RUA RONG][KET_THUC] ketQua="
    ...
    private void hoanTatChoKetThucPhatBan(
        ...
        synchronized (this) {
            ...
            if (hetHan) {
                System.out.println("[BOSS RUA RONG][ANIMATION_DAN_TIMEOUT] slot="
                        + slot + " phien=" + phien
    ...
    private int demBossSong() {
        int dem = 0;
        for (int i = CauHinhBossRuaRong.SLOT_BOSS_DAU;
                i <= CauHinhBossRuaRong.SLOT_BOSS_CUOI; i++) {
    ...
    private void phatLuot(ChickenChienBinh hienTai) throws IOException {
        ...
        System.out.println("[BOSS RUA RONG][LUOT] slot=" + slot
                + " ten=" + hienTai.ten
    ...
    private void datNapDanSauHanhDong(int slot, int giaTri) {
        ...
        this.boDemThuTuHanhDongNapDan =
                ChickenHangDoiNapDan.ghiNhanHanhDong(
                        ...
                        this.boDemThuTuHanhDongNapDan);
        ChickenChienBinh chienBinh = this.chienBinhs[slot];
        System.out.println("[BOSS RUA RONG][NAP_DAN] slot=" + slot
                + " ten=" + (chienBinh == null ? "null" : chienBinh.ten)
    ...
    private void phatDiChuyenRong(ChickenChienBinh rong) throws IOException {
        for (ChickenChienBinh nguoiNhan : this.nguoiChoiConPhien()) {
            nguoiNhan.nguoiChoi.dichVu.guiDiChuyenBigBoss(
                    rong.chiSo, rong.x, rong.y);
        }
    }
    ...
    private void phatBan(ChickenChienBinh shooter, ChickenKetQuaDan ketQua, byte soPhat)
        ...
        for (ChickenChienBinh nguoiNhan : this.nguoiChoiConPhien()) {
            try {
                ...
                System.err.println("[BOSS RUA RONG][GUI_PHAT_BAN_LOI] nguoiNhan="
                        + nguoiNhan.ten + " loi=" + loi.getMessage());
            }
        }
    }
    ...
    private void phaDiaHinhNeuCan(ChickenKetQuaDan ketQua) {
        ...
        if (daPhaDiaHinh) {
            ChickenTrongLucDiaHinhServer.dongBoYSauPhaDiaHinh(
                    this.banDo, this.chienBinhs,
                    chienBinh -> ChickenCoCheBayAVG.coTheBay(chienBinh)
                            || this.laBossRongBay(chienBinh));
        }
    }

    private boolean laBossRongBay(ChickenChienBinh chienBinh) {
        int slot = chienBinh == null ? -1 : chienBinh.chiSo & 0xFF;
        CauHinhBossRuaRong.CauHinh cauHinh =
                slot >= 0 && slot < this.cauHinhBoss.length
                        ? this.cauHinhBoss[slot]
                        : null;
        return cauHinh != null && cauHinh.laRong();
    }
