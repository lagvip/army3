...
public final class BossRuaRong extends ChickenQuanLyChien {
    ...
    private ChickenQuanLyCongThucSung.KiemTraBanDo kiemTraBanDo() {
        return new ChickenQuanLyCongThucSung.KiemTraBanDo() {
            @Override
            public int getWidth() { return BossRuaRong.this.banDo.getWidth(); }
            @Override
            public int getHeight() { return BossRuaRong.this.banDo.getHeight(); }
            @Override
            public boolean coVaCham(short x, short y) {
                return BossRuaRong.this.banDo.coVaCham(x, y);
            }
        };
    }
