...
public final class BossBaoVay extends ChickenQuanLyChien {
    private static final int SO_SLOT = 18;
    ...
    /** Bo ky nang AVG rieng dung chung mang chien binh cua tran boss. */
    ...
    private void taoBoss() {
        for (CauHinhBossBaoVay.CauHinh cauHinh : this.danhSachBoss) {
            ...
            short partSung = duLieu == null
                    ...
                    : duLieu.getPartSung();
            int tanCongDuPhong =
                    CauHinhBossBaoVay.layTanCongTheoSung(partSung);
    ...
    private int layNapDanBoss(int slot) {
        ...
        int duPhong = boss == null
                ? 100
                : CauHinhBossBaoVay.layNapDanTheoSung(
                        boss.maVuKhi);
    ...
    private synchronized void chuyenSangLuotTiepTheo(int sauSlot) throws IOException {
        ...
        if (slotTiep >= SO_SLOT_NGUOI_CHOI) {
            CauHinhBossBaoVay.CauHinh cauHinhTiep =
    ...
    private void thucHienBossBanSung(ChickenChienBinh boss, int slot, long phien) {
        ...
        try {
            ...
            System.err.println("[BOSS BAO VAY][LOI_XU_LY_PHAT_BAN] slot="
                    + slot + " ten=" + boss.ten
                    + " idSung=" + this.idSungBoss[slot]
    ...
    private void thucHienCamTu(
        ...
        synchronized (this) {
            ...
            if (BossCamTu.daCanTrucX(camTu, mucTieu)) {
                // Khong gui CMD 21 chi de doi Y: client se ep look=0 va
                // lam Cam tu xoay qua lai du khong he chay ngang.
                System.out.println("[BOSS BAO VAY][CAM_TU_DOI_CUNG_TRUC_X] boss="
            ...
            if (buoc == null || buoc.length < 2
                ...
                System.err.println("[BOSS BAO VAY][CAM_TU_BO_WAYPOINT_KHONG_HOP_LE] boss="
            ...
            System.out.println("[BOSS BAO VAY][CAM_TU_DI_CHUYEN] boss="
                    + camTu.ten
                    + " from=" + xTruoc + "," + yTruoc
                    + " to=" + camTu.x + "," + camTu.y
                    + " distance=" + daDi
            ...
            if (BossCamTu.daChamNguoiChoi(camTu, mucTieu)) {
                ...
                // Cho client noi suy xong CMD 21 roi moi gui CMD 22 no.
            ...
            // Moi Cam tu chi gui mot dich di chuyen trong mot luot.
            this.boHenGio.schedule(() -> this.sangLuotSauBoss(
                            slot, phien, BossCamTu.NAP_DAN_SAU_DI_CHUYEN),
    ...
    private boolean trongTamNoCamTu(
        ...
        return nguoiChoi != null
                ...
                && BossCamTu.trongPhamViKichNo(
                        camTu,
                        nguoiChoi,
                        CauHinhBossBaoVay.BAN_KINH_NO_CAM_TU);
    }
    ...
    private void noCamTu(
        ...
        try {
            ChickenKetQuaDan hieuUngNo = ChickenHoatAnhNoCamTu.tao(
                    camTu, mucTieu, CauHinhBossBaoVay.SAT_THUONG_CAM_TU);
            thoiGianHoatAnhNo = ChickenThoiGianHoatAnhDan.tinh(hieuUngNo);
            this.phatBan(camTu, hieuUngNo, (byte) 1);
            this.banDo.phaDiaHinh(
                    camTu.x,
                    camTu.y,
                    CauHinhBossBaoVay.LOAI_DAN_HIEU_UNG_NO_CAM_TU);
        } catch (IOException loi) {
            System.err.println("[BOSS BAO VAY][CAM_TU_LOI_HIEU_UNG] boss="
        ...
        for (int i = 0; i < SO_SLOT_NGUOI_CHOI; i++) {
            ...
            int satThuongTheoKhoangCach =
                    BossCamTu.tinhSatThuongNoTheoKhoangCach(
                            ...
                            CauHinhBossBaoVay.BAN_KINH_NO_CAM_TU,
                            CauHinhBossBaoVay.PHAN_TRAM_DAMAGE_RIA_CAM_TU);
            ...
            try {
                ...
                System.err.println("[BOSS BAO VAY][CAM_TU_LOI_DAMAGE] boss="
        ...
        try {
            ...
            System.err.println("[BOSS BAO VAY][CAM_TU_LOI_CAP_NHAT_MAU] boss="
                    + camTu.ten + " loi=" + loi.getMessage());
        }
        System.out.println("[BOSS BAO VAY][CAM_TU_NO] boss=" + camTu.ten
                + " targetKichNo=" + mucTieu.ten + " damage="
                + CauHinhBossBaoVay.SAT_THUONG_CAM_TU
                + " banKinh=" + CauHinhBossBaoVay.BAN_KINH_NO_CAM_TU
                + " damageRia="
                + CauHinhBossBaoVay.PHAN_TRAM_DAMAGE_RIA_CAM_TU + "%"
    ...
    private void hoanTatChoKetThucPhatBan(int slot, long phien) {
        synchronized (this) {
            ...
            try {
                ...
                System.err.println("[BOSS BAO VAY][LOI_CHUYEN_LUOT_SAU_DAN] slot="
    ...
    private void phatBan(ChickenChienBinh shooter, ChickenKetQuaDan ketQua, byte soPhat)
        ...
        for (ChickenChienBinh nguoiNhan : this.nguoiChoiConPhien()) {
            try {
                ...
                System.err.println("[BOSS BAO VAY][GUI_PHAT_BAN_LOI] nguoiNhan="
